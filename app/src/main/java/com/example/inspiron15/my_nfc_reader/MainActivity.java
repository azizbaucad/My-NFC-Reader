...
import com.example.inspiron15.my_nfc_reader.parser.NdefMessageParser;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = NFCTagActivity.creatIntentForReading(MainActivity.this, "FROMNFC");
        MainActivity.this.startActivityForResult(intent, NFCTagActivity.READ_REQUEST_CODE);
       // finish();

        text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Intent intent = new Intent(MainActivity.this, FromnfcActivity.class);
        ...
        if (requestCode == NFCTagActivity.READ_REQUEST_CODE && resultCode == NFCTagActivity.READ_REQUEST_CODE) {
            ...
            switch (actionType) {
                case "TONFC":
                    ...
                    intent = new Intent(MainActivity.this, FromnfcActivity.class);
                    break;
                case "FROMNFC":
                    intent = new Intent(MainActivity.this, FromnfcActivity.class);
                    break;
