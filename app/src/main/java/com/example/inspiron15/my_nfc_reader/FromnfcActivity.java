...
import com.example.inspiron15.my_nfc_reader.helper.DialogHelper;
import com.example.inspiron15.my_nfc_reader.models.AppRegistry;
import com.example.inspiron15.my_nfc_reader.models.Setting;
...
import static com.example.inspiron15.my_nfc_reader.R.color.venteEchec;
  ...
  // private static final String url = "http://" + AppRegistry.HOST + "/sib/pmeNFC";
   ...
   private AppBarLayout scrollView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // scrollView.setBackgroundColor(R.color.toolbar);
...
// chercher l'etudiant avec l'id de la carte
 public void getEtudianByIdCarte(){
    ...
    final String getConfCode = "testtesdone";
    ...
    try {
      ...
      //  jsonobject_pawd.put("second",getConfCode);
        ...
        Log.e("iiiiiiddddd de la carte",jsonobject.toString() );
