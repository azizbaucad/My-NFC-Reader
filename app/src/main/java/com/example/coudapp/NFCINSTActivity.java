...
import com.example.coudapp.NFCManager.NFCManager;
import com.example.coudapp.NFCManager.NFCWriteException;
...
public class NFCINSTActivity extends AppCompatActivity implements NFCManager.TagReadListener, NFCManager.TagWriteListener, NFCManager.TagWriteErrorListener {
    ...
    private void changeStatus(boolean isOperationOk){
        ...
        if(isOperationOk) {
            ...
            //Toast.makeText(NFCINSTActivity.this, "This is default toast message", Toast.LENGTH_SHORT).show();
    ...
    public void onTagRead(String tagId) {
        ...
        this.timer.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                intent.putExtra(NFCTagActivity.ACTION_DATA_CUSTOM, NFCINSTActivity.this.dataCustom);
                NFCINSTActivity.this.setResult(NFCTagActivity.READ_REQUEST_CODE, intent);
                NFCINSTActivity.this.finish();
            }
        }, 10);
    }
